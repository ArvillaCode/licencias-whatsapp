...
monthlyRecordsRouter.get('/bills/:billId/monthly-records', async (req, res) => {
...
monthlyRecordsRouter.get('/monthly-records/:id', async (req, res) => {
...
monthlyRecordsRouter.put('/monthly-records/:id', async (req, res) => {
