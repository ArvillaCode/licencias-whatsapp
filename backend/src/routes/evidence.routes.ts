...
evidenceRouter.get('/monthly-records/:id/evidence', async (req, res) => {
...
evidenceRouter.post('/monthly-records/:id/evidence', uploadEvidence.array('files', 10), async (req, res) => {
